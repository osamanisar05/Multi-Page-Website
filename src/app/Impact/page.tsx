export default function Impact(){
    return(
        <div>
            <h1><b>Community Impact and Initiatives</b></h1>       
            <p>We are dedicated to moving individuals and communities from all walks of life to adopt healthier, more active lifestyles.</p>     
            <h1><b>Our work in motion</b></h1>
            <h1><b>Community Physical Activity Leaders</b></h1>
            <p>We believe the key to getting more people moving starts with access, education and empowerment. At the heart of ACE IMPACT lies the Community Physical Activity Leader (CPAL) – our way of contributing toward equal access and opportunities for everyone to engage in a healthy, more active lifestyle.
