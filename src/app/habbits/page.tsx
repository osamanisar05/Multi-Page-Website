export default function Habbits(){
    return(
        ...
        <p>Complete daily hygiene practices, review your schedule and outline your main tasks for the day. This keeps you organized and focused. </p><br></br>
        <p>To ensure you get physical-activity breaks throughout your day, use this formula, which will ensure you get some unstructured movement that helps to burn calories and boost health benefits: 
        <br></br>For every 30 minutes, sit for 20, stand for 8 and move for 2.</p><br></br>
        <h3><b>Sample Evening Routine</b></h3><br></br>
        <p>An effective evening routine can help you unwind, promote restful sleep and prepare you for the next day.</p><br></br>
        <h3><b>1 Enjoy dinner (6:00–6:45 p.m.)</b></h3><br></br>
        <p>* Take time to connect with your family, friends and your meal (e.g., be mindful as you eat and savor the experience). Following dinner, this might be an opportunity to prepare a lunch for the next day, if necessary, or go for a short walk. </p><br></br>
        <h3><b>2 Unwind (6:45–8:45 p.m.) </b></h3><br></br>
        <p>* Engage in a relaxing activity like reading, journaling, listening to calming music, watching TV or playing video games.</p><br></br>
        <h3><b>3 Gentle stretching or relaxation (8:45–8:55 p.m.)</b></h3><br></br>
        <p>* Engage in gentle stretching or relaxation exercises to release muscle tension and prepare your body for sleep.  </p><br></br>
        <h3>4 Disconnect and prepare for the next day (8:55–9:10 p.m.) <b></b></h3><br></br>
        <p>* Turn off electronics and lay out your clothes and organize any materials needed for the next day. This reduces morning stress and ensures a smooth start. This might also be a time to practice reflection and gratitude and to jot down your “wins” for the day. </p><br></br>
        <h3><b>5 Sleep hygiene routine (9:10–10:00 p.m.)</b></h3><br></br>
        <p>* Establish a consistent sleep schedule by going to bed at the same time each night. Create a restful environment by dimming lights, setting a comfortable temperature and practicing relaxation techniques like deep breathing or progressive muscle relaxation. This window might involve reading to kids or unwinding in other ways to signal the body that it’s time to sleep. </p><br></br>
        <h4><b>Final Thoughts</b></h4><br></br>
        <p>It is important to note that a routine is designed to create a predictable structure and assist with efficient decision making, but flexibility is a key component. There will be events that can tilt your day or evening in one direction or another. There’s power in honoring the space you’re in and moving forward intentionally. It’s okay if routines need to be “tweaked” to accommodate shifts you and your family may experience.  
        <br></br>Find what works for you and personalize these routines to fit your lifestyle and preferences. The key is to be consistent and find a rhythm that promotes healthy habits and makes you feel your best. So, ditch the daily scramble and embrace the power of routines. You might just be surprised at how much smoother and more fulfilling your life becomes. 
        <br></br>To learn more about healthy habits for you and your family, read Back to School: Healthy Habits for Kids and Families. In that article, you’ll learn strategies to incorporate healthy eating, physical activity and stress-management routines into your busy schedule.</p><br></br>
